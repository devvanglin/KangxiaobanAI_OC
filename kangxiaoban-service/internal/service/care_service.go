...
func (s *CareService) ListPlans(ctx context.Context, elderID uint, page, size int) ([]model.CarePlan, int64, error) {
	return s.repo.ListPlans(ctx, elderID, page, size)
}
...
func (s *CareService) ListExecutions(ctx context.Context, elderID, itemID uint, page, size int) ([]model.CareExecution, int64, error) {
	return s.repo.ListExecutions(ctx, elderID, itemID, page, size)
}
