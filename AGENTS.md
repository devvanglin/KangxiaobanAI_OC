...
| `component/wide/WideAssessmentAgentPage.ets` | native HDS voice/text assessment, microphone permission fallback, progress, resume, completion handoff; question at top-left, per-question no-answer countdown at top-right, and the central Mood Mates Nimbo expression stage (`rawfile/moodmates/`, ArkWeb + `window.stage.setEmotion` bridge) whose emotion follows the assessment phase (01 connecting, 39 TTS, 35 listening, 30 generating, 03 urgent, 33 done, 34 error) |
